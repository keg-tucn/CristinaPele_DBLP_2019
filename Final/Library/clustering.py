...
def apply_XMeans(X, nr_cluster_initial, kmax):
	initial_centers = kmeans_plusplus_initializer(X, nr_cluster_initial,kmeans_plusplus_initializer.FARTHEST_CENTER_CANDIDATE).initialize()
...
def apply_fuzzy(X, nr_cluster_initial):
